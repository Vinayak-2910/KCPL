...
export default function Footer() {
  return (
    <footer
      id="site-footer"
      className="relative z-10 border-t border-stone-300 bg-surface"
    >
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 sm:px-8 md:grid-cols-3">
        ...
        <div>
          ...
          <address className="text-sm not-italic leading-7 text-slate-600">
            {company.name}
            <br />
            {company.address}
          </address>
      ...
      <div className="border-t border-stone-300 py-5 text-center text-xs text-slate-600">
