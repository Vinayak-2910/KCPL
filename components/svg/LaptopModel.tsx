    ...
    >
      ...
      <g clipPath="url(#lm-clip)">
        ...
        <g data-screen="stats" opacity="0">
          ...
          <polyline
            points="152,150 230,120 300,96 396,62"
            stroke="#f59e0b"
            strokeWidth="5"
            strokeLinecap="round"
            fill="none"
            ...
            [0, 1].map((r) => (
              <g key={`${c}-${r}`}>
                <rect
                  ...
                  height="64"
                  rx="12"
                  fill={(c + r) % 2 ? "#dbeafe" : "#2563eb"}
                />
                <circle
                  cx={186 + c * 96}
                  cy={104 + r * 82}
                  r="11"
                  fill={(c + r) % 2 ? "#2563eb" : "#f59e0b"}
                />
              </g>
            )),
          )}
        ...
        <g data-screen="why-us" opacity="0">
          ...
          <path
            d="M280 104 l8.6 17.4 19.2 2.8 -13.9 13.6 3.3 19.1L280 148l-17.2 9 3.3-19.1-13.9-13.6 19.2-2.8Z"
            fill="#f59e0b"
          />
          <path
            d="M234 190 q46 26 92 0"
            stroke="#1e3a8a"
            strokeWidth="5"
            strokeLinecap="round"
            fill="none"
        ...
        <g data-screen="cta" opacity="0">
          ...
          <path
            d="M366 168 l7 22 6-8.4 10 8 4.4-5.4-10-8 9-4.8Z"
            fill="#0f172a"
          />
        </g>

        {/* ZOOM - flat surface gray; the live miniature overlays this, so
            this fill must track --color-surface or the dive flashes. */}
        <g data-screen="zoom" opacity="0">
          <rect x="94" y="34" width="372" height="222" fill="#ece9e3" />
        </g>
      </g>

      {/* Screen glare */}
      <path
        d="M94 200 240 34h74L134 256h-30a10 10 0 0 1-10-10Z"
        fill="#ffffff"
        opacity="0.14"
      ...
      {/* Deck */}
      <path
        d="M46 286h468a8 8 0 0 1 7.6 5.5l13.8 41.3A8 8 0 0 1 527.8 343H32.2a8 8 0 0 1-7.6-10.2l13.8-41.3A8 8 0 0 1 46 286Z"
        fill="url(#lm-deck)"
      />
      {/* Hinge */}
      ...
      {/* Base edge */}
      <path
        d="M32.2 343h495.6a8 8 0 0 0 7.6-5.4l.4-1.1c1.7 5.2-2.2 15.5-8 15.5H32.2c-5.8 0-9.7-10.3-8-15.5l.4 1.1a8 8 0 0 0 7.6 5.4Z"
        fill="#64748b"
      />
    </svg>
  );
