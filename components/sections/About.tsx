    ...
    >
      ...
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-5 py-24 sm:px-8 lg:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-8 space-y-5">
            {about.paragraphs.map((paragraph) => (
              <p
                ...
                data-reveal
                className="text-base leading-8 text-slate-500"
              >
                {paragraph}
              </p>
            ))}
          ...
          <blockquote
            data-reveal
            className="mt-10 border-l-4 border-accent-500 bg-white/70 py-4 pl-6 pr-4 font-display text-xl font-semibold italic text-brand-900 shadow-sm"
          >
            “{about.pullQuote}”
          </blockquote>
        </div>
