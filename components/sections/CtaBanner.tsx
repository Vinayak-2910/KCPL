  ...
  return (
    ...
    >
      ...
      <div className="mx-auto w-full max-w-4xl px-5 pb-28 pt-28 text-center sm:px-8 lg:pt-[42vh]">
        ...
        <p data-reveal className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-500">
          {ctaBanner.sub}
        </p>
        ...
        <p data-reveal className="mt-8 text-xs font-medium uppercase tracking-[0.24em] text-slate-400">
