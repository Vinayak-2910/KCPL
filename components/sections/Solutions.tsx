          ...
          <div className="mt-12 grid gap-5 sm:grid-cols-2">
            {solutions.items.map((item, index) => (
              <div
                key={item.title}
                data-reveal
                className="group rounded-2xl border border-slate-200 bg-white/80 p-6 shadow-sm transition-all hover:-translate-y-1 hover:border-brand-300 hover:shadow-lg hover:shadow-brand-700/10"
              >
