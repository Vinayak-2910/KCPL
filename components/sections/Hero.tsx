  ...
  useGSAP(
    () => {
      ...
      mm.add("(prefers-reduced-motion: reduce)", () => {
        gsap.set([stageBRef.current, stageCRef.current, whiteRef.current], {
          autoAlpha: 0,
        });
    ...
    >
      ...
      >
        ...
        <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
          ...
          <a
            href="#process"
            className="rounded-full border border-stone-400 bg-surface px-7 py-3.5 text-sm font-semibold text-slate-700 transition-all hover:-translate-y-0.5 hover:border-brand-400 hover:text-brand-700"
          >
            {hero.secondaryCta}
          </a>
        </div>
